...
public class ContextCard implements IContextCard {
    ...
    public View getContextCard(Context context) {
        ...
        Text_a_0.setText("COMET?");
        System.out.println("sound_frequency11111111111");
        ...
        if (latest != null && latest.moveToFirst()) {
            ...
            Text_a_0.setText("COMET is super super cleverrrrrr");
            ...
            Text_a_0.setText("COMET is super cleverrrrrr");

        }
        if (latest != null && !latest.isClosed()) latest.close();
        System.out.println("sound_frequency2222222222222");
        ...
        System.out.println("sound_frequency333333333333");
        return card;
    }
    private static GraphicalView drawGraph( Context context ) {
        System.out.println("sound_frequency444444444444");
